...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// i have no clue what this does but that didn't stop me from commenting on it
        /// </summary>
        ...
        /// <summary>
        /// returns and removes the val
        /// </summary>
        /// <returns>the TValue contained in the root</returns>
